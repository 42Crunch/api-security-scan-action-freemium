...
def main():
    ...
    # Map inputs to args
    arg_parser.add_argument('--input-target-url', type=str, help='Target url', required=True)
    arg_parser.add_argument('--input-api-definition', type=str, help='Api definition', required=True)
    arg_parser.add_argument('--input-api-credential', type=str, help='Api credential', default=None)
    ...
    arg_parser.add_argument('--input-scan-report', type=str, help='Scan report', default=None)
    ...
    arg_parser.add_argument('--github-organization', type=str, help='Github organization', default=lambda: random_string(10))
